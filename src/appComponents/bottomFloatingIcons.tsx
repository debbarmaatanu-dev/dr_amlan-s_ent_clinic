  ...
  return (
    <div className="fixed bottom-5 left-6 z-50 flex items-center justify-center sm:bottom-25 lg:bottom-5">
      ...
      <a
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-all duration-150 ease-in-out hover:bg-green-600 focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:ring-offset-2 focus-visible:outline-none active:scale-90"
...
export const UpArrowIcon = () => {
  ...
  return (
    <div className="fixed right-6 bottom-5 z-50 flex items-center justify-center sm:bottom-25 lg:bottom-5">
      <button
        onClick={scrollToTop}
        className="relative flex h-14 w-14 cursor-pointer items-center justify-center rounded-full bg-blue-600 text-white shadow-lg transition-all duration-150 ease-in-out hover:bg-blue-600 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:outline-none active:scale-90"
