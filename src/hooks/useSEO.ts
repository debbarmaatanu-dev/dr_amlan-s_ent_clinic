...
const seoPages: Record<string, SEOData> = {
  ...
  '/faq': {
    ...
    keywords:
      'ENT clinic FAQ Agartala, Dr Amlan Debbarma questions, ENT consultation fees Tripura, clinic timings Agartala, Sunday ENT clinic, Wednesday closed, ENT appointment booking, ENT treatment questions',
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            ...
            text:
              CLINIC_SCHEDULE_SUMMARY +
              ' Online booking available on open days.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'You can book online through our Appointment page (10 slots per day) or walk-in at the clinic during consultation hours (10 additional offline slots). Contact us at +91 6033521499 or WhatsApp +91 6033521499 for assistance.',
          },
        },
        {
          '@type': 'Question',
